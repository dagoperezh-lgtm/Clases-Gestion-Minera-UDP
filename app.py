...
st.markdown("""
    <style>
    .titulo-slide { font-size: 3.5rem; color: #1E3A8A; font-weight: bold; margin-bottom: 20px; line-height: 1.2;}
    ...
    .alerta { background-color: #FEF2F2; border-left: 8px solid #991B1B; padding: 20px; font-size: 1.8rem; color: #991B1B;}
    </style>
...
# ==============================================================================
    ...
    st.write("### Controles de la Presentación")
    slide = st.radio("Seleccione la Diapositiva:", ["Pág 5: El Propósito", "Pág 6: La Secuencia Tradicional", "Pág 7: El Equilibrio de Éxito"], horizontal=True)
    st.divider()
    ...
    elif slide == "Pág 6: La Secuencia Tradicional":
    ...
    elif slide == "Pág 7: El Equilibrio de Éxito":
        st.markdown('<div class="titulo-slide">La Fórmula del Impacto: 50/50</div>', unsafe_allow_html=True)
        st.markdown('<div class="texto-slide">Para lograr que un proyecto se ejecute (por ejemplo, implementar una nueva tecnología de predicción de fallas), la presentación requiere balancear dos mundos con la misma rigurosidad:</div><br>', unsafe_allow_html=True)
        
        col_a, col_b = st.columns(2)
        with col_a:
            st.markdown('<div style="background-color:#1E3A8A; padding:30px; border-radius:10px; color:white; text-align:center;"><h1 style="font-size:4rem; color:white; margin:0;">50% TÉCNICA</h1><p style="font-size:1.8rem;">La calidad del dato, la rigurosidad del análisis y la estructura lógica de los argumentos.</p></div>', unsafe_allow_html=True)
        with col_b:
            st.markdown('<div style="background-color:#DC2626; padding:30px; border-radius:10px; color:white; text-align:center;"><h1 style="font-size:4rem; color:white; margin:0;">50% ARTE</h1><p style="font-size:1.8rem;">El diseño visual limpio, la empatía con la audiencia y la histrionismo en la puesta en escena.</p></div>', unsafe_allow_html=True)
# ==============================================================================
# FIN MÓDULO 01
# ==============================================================================
...
# ==============================================================================
    ...
    st.write("### Controles de la Presentación")
    slide = st.radio("Seleccione la Diapositiva:", ["Pág 24-25: Los 7 Pasos", "Pág 28: Esquema", "Pág 30: Guión y Problema", "Pág 32: Resumen"], horizontal=True)
    st.divider()
    ...
    if slide == "Pág 24-25: Los 7 Pasos":
        ...
        with col1:
            st.markdown('<div class="texto-slide"><b>1º Objetivo:</b> Identifique la audiencia. Defina el Objetivo.<br><br>'
                        '<b>2º Adaptación:</b> Adapte la estructura, ajuste el tiempo, evalúe el conocimiento previo.<br><br>'
                        '<b>3º Mensaje:</b> Defina el mensaje con que quiere que la audiencia se quede. Evalúe el lenguaje y tono.<br><br>'
                        '<b>4º Tiempo:</b> Es requisito calcular el tiempo de la presentación y ensayar rigurosamente.</div>', unsafe_allow_html=True)
        with col2:
            st.markdown('<div class="texto-slide"><b>5º Contenidos:</b> Defina las ideas ancla. Diagrame cómo va a entregar esas ideas y mensajes.<br><br>'
                        '<b>6º Estructura:</b> Defina la estructura (Introducción, Capítulos, Casos, Conclusiones).<br><br>'
                        '<b>7º Trabaje en los contenidos:</b> Para presentaciones largas desarrolle una especie de Guión Gráfico.</div>', unsafe_allow_html=True)
        ...
        st.markdown('<div class="destacado"><b>Introducción:</b> Con énfasis en el mensaje clave.<br><br>'
                    '<b>Desarrollo:</b> Análisis, datos, gráficos que respalden el mensaje.<br><br>'
                    '<b>Conclusión:</b> Entregar una conclusión acorde a los contenidos mostrados, que refuerce el mensaje y llame a la acción.</div>', unsafe_allow_html=True)
        ...
        st.markdown('<div class="texto-slide">• Permite visualizar cómo enlazan los temas de la presentación.<br>'
                    '• Permite identificar desencadenantes de apoyos audiovisuales.<br>'
                    '• Permite hacer cierres de objetivos intermedios y preparar el cierre final.</div>', unsafe_allow_html=True)
        ...
        st.markdown('<div class="texto-slide">Trabajar en el análisis y la presentación en forma simultánea, aplicando los 7 pasos:<br><br>'
                    'Definir objetivo, adecuar a la audiencia, definir el mensaje clave, identificar el tiempo adecuado, hacer un diagrama, definir la estructura de láminas y trabajar en el contenido.<br><br>'
                    '<i>Enuncie un problema e incluya introducciones y resúmenes a lo largo de la presentación.</i></div>', unsafe_allow_html=True)
# ==============================================================================
# FIN MÓDULO 02
# ==============================================================================
